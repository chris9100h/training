...
- `zane_water_logs`: Per-Entry-Wasserlog des Water-Trackers (`WaterScreen`); Tagessumme wird zurück in `zane_daily_logs.water_ml` gespiegelt; Store-Collection wie Cardio-Logs. Migration 0180
