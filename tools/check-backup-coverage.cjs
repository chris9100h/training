...
function captureImportedColumns() {
  ...
  const backup = {
    ...
    waterLogs: [{}], adaptiveTdeeHistory: [{ asOfDate: '2026-01-01', windowStart: '2025-12-19', windowEnd: '2026-01-01', tdee: 2000, avgCalories: 1900, weightStartKg: 80, weightEndKg: 79.5, weightChangeKg: -0.5, weightRateKgWeek: -0.25, daySpan: 10, calorieDays: 5, weighIns: 6 }], foodLogs: [{}], foodFavorites: [{}], foodBarcodeOverrides: [{ source: 'off', sourceId: '0123456789012', foodName: 'Test food', kcalPer100g: 100, proteinPer100g: 10, carbsPer100g: 10, fatPer100g: 1 }], foodRecipes: [{}],
