  ...
  return (
    <Screen scroll={false}>
      ...
      {screenFlash && ReactDOM.createPortal(
        <div style={{ position: 'fixed', top: '-100px', left: 0, right: 0, bottom: 0, zIndex: 200, background: UI.gold, opacity: 0.28, pointerEvents: 'none' }} />,
        document.body
      )}
      ...
      {(improvedSet || regressionSet || newBestSet || !!progressionUnlocked) && ReactDOM.createPortal(
        <div style={{ position: 'fixed', top: '-100px', left: 0, right: 0, bottom: 0, zIndex: 100 }} />,
        document.body
      )}
      ...
      {newBestSet && ReactDOM.createPortal(
        <div style={{
          position: 'fixed', top: '-100px', left: 0, right: 0, bottom: 0, zIndex: 155, pointerEvents: 'none',
      ...
      {improvedSet && ReactDOM.createPortal(
        <div style={{
          position: 'fixed', top: '-100px', left: 0, right: 0, bottom: 0, zIndex: 150, pointerEvents: 'none',
          background: 'rgb(8,6,3)',
          animation: 'improvedFade 2.5s ease forwards',
          animationFillMode: 'forwards',
        }}>
      ...
      {progressionUnlocked && ReactDOM.createPortal(
        <div onClick={() => { setProgressionUnlocked(null); if (pendingNavRef.current) { pendingNavRef.current = false; navigate(1); } }} style={{
          position: 'fixed', top: '-100px', left: 0, right: 0, bottom: 0, zIndex: 160,
          background: 'rgb(8,6,3)',
