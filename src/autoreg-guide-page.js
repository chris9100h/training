...
(function(){
  ...
  function guideHTML(M){
    ...
    out+='<div class="grid g180">'+
      ...
      stat('Reset & re-ramp','Back off, build again',null,'On that reset each exercise drops straight back to your plan\'s starting set count (never lower), then set adds climb again, capped by the same learned ceiling.')+
      '</div>';
    out+='<div class="card lb accented" style="margin-top:16px"><div class="kick" style="color:var(--accent)">Per mode</div><div style="margin-top:6px;font-size:13.5px;color:var(--ink-soft)">'+
