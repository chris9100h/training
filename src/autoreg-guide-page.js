...
(function(){
  ...
  function guideHTML(M){
    ...
    out+='<div class="grid g180">'+
      ...
      stat('Reset & re-ramp','Back off, build again',null,'On that reset each exercise drops back to its current floor, not zero. That floor starts at your plan\'s set count and drifts with your learned ceiling over blocks instead of staying frozen there forever, then set adds climb again, capped by the same ceiling.')+
      '</div>';
    out+='<div class="card lb accented" style="margin-top:16px"><div class="kick" style="color:var(--accent)">Per mode</div><div style="margin-top:6px;font-size:13.5px;color:var(--ink-soft)">'+
