...
(function(){
  ...
  function guideHTML(M){
    ...
    out+='<div class="grid g220" style="margin-top:14px">'+
      ...
      '<div class="card"><h3 class="display h3">Warnings, one line</h3><p style="font-size:13.5px;color:var(--ink-soft)">Sharp joint pain sets a durable swap warning.'+(isB?'':' Low pump 3 sessions running suggests changing the exercise, not adding sets.')+'</p></div></div>';
