...
window.WHATS_NEW = [
  ...
  },
  {
    ...
    items: [
      ...
      "📦 Keep tabs on what you've actually got: the Shopping List has an Inventory tab where you set how much of something you have and its package size, then it counts down automatically as you log it in Food. Cross a threshold and a Running Low heads-up shows up so you're not the one finding out at the worst moment. It also just got sharper: instead of a rough day-count guess, it now works out your real remaining stock the moment you open the tab, so a 20kg bag that lasts way longer than a month finally adds up correctly too.",
