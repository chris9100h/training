...
function LoginScreen() {
  ...
  }, "iron \xB7 sweat \xB7 numbers"));
  const tabs = /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      borderBottom: `1px solid ${UI.inkLine}`
    }
  }, [['login', 'Einloggen'], ['register', 'Registrieren']].map(([id, label]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    onClick: () => {
      setMode(id);
      setError('');
  ...
  return /*#__PURE__*/React.createElement(Screen, {
    ...
    style: {
      ...
      color: UI.danger,
      padding: '8px 12px',
      background: 'rgba(200,116,105,0.08)',
      borderRadius: 8
    }
  }, error), info && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: UI.ok,
      padding: '8px 12px',
...
function HomeScreen({
  ...
  if (!sch) {
    return /*#__PURE__*/React.createElement(Screen, null, /*#__PURE__*/React.createElement(TopBar, {
      ...
      sub: new Date().toLocaleDateString('de-DE', {
        weekday: 'long',
        day: 'numeric',
        month: 'long'
      }),
  ...
  return /*#__PURE__*/React.createElement(Screen, null, /*#__PURE__*/React.createElement(TopBar, {
    ...
    }, i === 0 ? 'HEUTE' : `+${i}`), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        fontWeight: 600,
        marginTop: 3,
        color: r ? UI.inkSoft : isToday ? UI.gold : UI.ink
      }
    }, r ? '—' : d.name.slice(0, 4)));
  })), isRest ? /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(Label, null, "Heute \xB7 Tag ", dayIdx + 1, " von ", dayCount), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 28,
      fontWeight: 600,
      marginBottom: 4
  ...
  }, "Erholung ist Teil des Plans. Tomorrow is leg day."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
  ...
  }, "Rest abhaken \u2192"), /*#__PURE__*/React.createElement(Btn, {
    kind: "ghost",
    onClick: () => go({
      name: 'plan'
    }),
  ...
  }, "Plan ansehen"))) : /*#__PURE__*/React.createElement(Card, {
    accent: true
  }, /*#__PURE__*/React.createElement(Label, {
    style: {
      color: UI.gold
    }
  }, "Heute \xB7 Tag ", dayIdx + 1, " von ", dayCount), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 28,
      fontWeight: 600,
      color: UI.gold,
  ...
  }, day.items.length, " \xDCbungen \xB7 ~", Math.round(day.items.reduce((a, b) => a + b.sets * 2 + 3, 0)), " min"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 6,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontSize: 14,
        padding: '6px 0',
        borderBottom: i < day.items.length - 1 ? `1px dashed ${UI.goldSoft}` : 'none'
      }
  ...
  }, "Training starten \u2192"), /*#__PURE__*/React.createElement(Btn, {
    kind: "ghost",
    onClick: async () => {
      if (await confirm('Der aktuelle Tag wird übersprungen.', {
  ...
  }, "Tag \xFCberspringen"))), lastSession && /*#__PURE__*/React.createElement(Card, {
    style: {
      padding: 14
    }
  }, /*#__PURE__*/React.createElement(Label, null, "Letzte Session"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      alignItems: 'center'
  ...
  }, lastSession.dayName), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: UI.inkFaint
    }
  }, new Date(lastSession.ended).toLocaleDateString('de-DE', {
    day: 'numeric',
    month: 'short'
  }), " \xB7", ' ', totalVolume(lastSession).toLocaleString('de-DE'), " kg")), /*#__PURE__*/React.createElement(Btn, {
    kind: "icon",
    onClick: () => go({
      name: 'session',
...
function totalVolume(session) {
  return session.entries.reduce((sum, ex) => sum + (ex.sets || []).reduce((s, st) => s + (+st.kg || 0) * (+st.reps || 0), 0), 0);
}
