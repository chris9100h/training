-- Social nutrition summaries use the same completed-day boundary as adherence.
-- A partially logged current day must not lower or inflate a friend's weekly
-- average before the day is finished.
