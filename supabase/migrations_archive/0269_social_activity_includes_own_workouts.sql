-- Keep the owner's own live and finished workouts in Activity.  The social
-- feed is also the durable entry point for opening workout comments, so an
-- owner must be able to find their own sessions after training ends.
