...
Deno.serve(async (req) => {
  ...
  const modelCall = { system: SYSTEM_PROMPT, userText, maxTokens: 6000, reasoningBudget: null };
  ...
  return jsonResponse(sanitizeMapping(parsed, headers, sourceExercises, existingExercises), 200);
});
