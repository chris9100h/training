-- Exclude skipped sets from avg_sets_total and sets_total in both RPC functions.
-- Skipped sets take no time so including them inflates histPace and remaining estimates.
