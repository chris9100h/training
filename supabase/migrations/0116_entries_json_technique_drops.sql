-- Add technique and drops to zane_entries_json so the spectator/comparison
-- screens receive intensity-technique data from the RPC (columns were added in
-- 0115 but the function was never updated to include them).
