-- Migration 0135: add planned_progression_offset to zane_session_entries
-- Per-exercise override for Smart Progression: null = inherit the global
-- smart_progression + progression_range_top setting, 0 = explicitly
-- disabled for this exercise, N = explicitly enabled with a ceiling of
-- base reps + N (overriding the global setting either way).
ALTER TABLE zane_session_entries ADD COLUMN planned_progression_offset int;
